...
// AUTO-GENERATED-COMPONENTS-START
          ...
          },
          {
            text: 'Displays',
            collapsed: true,
            items: [{"text":"2.9\\\" e-Paper Display (beta)","link":"/components/openhw-ePaperDisplay"},{"text":"7-Segment Display","link":"/components/openhw-7segment"},{"text":"ILI9341 2.8\\\" TFT LCD","link":"/components/openhw-ili9341"},{"text":"ILI9341 2.8\\\" Touch Screen LCD","link":"/components/openhw-ili9341-touch"},{"text":"LCD 16x2 (I2C)","link":"/components/openhw-lcd1602-i2c"},{"text":"LCD 16x2 (Parallel)","link":"/components/openhw-lcd1602"},{"text":"LCD 20x4 (I2C)","link":"/components/openhw-lcd2004-i2c"},{"text":"LCD 20x4 (Parallel)","link":"/components/openhw-lcd2004"},{"text":"LED","link":"/components/openhw-led"},{"text":"MAX7219 Dot Matrix","link":"/components/openhw-max7219"},{"text":"NeoPixel Matrix","link":"/components/openhw-neopixel-matrix"},{"text":"NeoPixel Ring","link":"/components/openhw-neopixel-ring"},{"text":"Nokia 5110 Screen","link":"/components/openhw-nokia-5110"},{"text":"RGB LED (4-pin)","link":"/components/openhw-rgb-led"},{"text":"Seven Segment Display (TM1637)","link":"/components/openhw-tm1637-7segment"},{"text":"SPI LED Driver (NLSF595)","link":"/components/openhw-nlsf595"},{"text":"SSD1306 OLED 128x64","link":"/components/openhw-ssd1306-oled"}]
          },
          {
            text: 'Actuators',
            collapsed: true,
