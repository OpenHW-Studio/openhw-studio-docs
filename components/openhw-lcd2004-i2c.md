...
<div class="component-preview">
  <div class="component-svg-wrap">
    <svg width="150" height="90" viewBox="0 0 150 90" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="75" y="30" fill="#f8fafc" font-family="monospace" font-size="10" font-weight="bold" text-anchor="middle">OpenHW Studio 20x4</text>
      <text x="75" y="45" fill="#f8fafc" font-family="monospace" font-size="10" font-weight="bold" text-anchor="middle">Line 2 text...</text>
      <text x="75" y="60" fill="#f8fafc" font-family="monospace" font-size="10" font-weight="bold" text-anchor="middle">Line 3 text...</text>
      <text x="75" y="75" fill="#f8fafc" font-family="monospace" font-size="10" font-weight="bold" text-anchor="middle">Line 4 text...</text>
    ...
    <span style="font-size:11px;color:#4a5568;">I2C 20x4 LCD</span>
  </div>
