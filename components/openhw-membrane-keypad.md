...
<div class="component-preview">
  <div class="component-svg-wrap">
    <svg width="100" height="120" viewBox="0 0 100 120" xmlns="http://www.w3.org/2000/svg">
      ...
      <rect x="30" y="105" width="40" height="15" fill="#f8fafc" />
      <rect x="32" y="105" width="2" height="15" fill="#94a3b8" />
      <rect x="37" y="105" width="2" height="15" fill="#94a3b8" />
      <rect x="42" y="105" width="2" height="15" fill="#94a3b8" />
      <rect x="47" y="105" width="2" height="15" fill="#94a3b8" />
      <rect x="52" y="105" width="2" height="15" fill="#94a3b8" />
      <rect x="57" y="105" width="2" height="15" fill="#94a3b8" />
      <rect x="62" y="105" width="2" height="15" fill="#94a3b8" />
      <rect x="67" y="105" width="2" height="15" fill="#94a3b8" />
    </svg>
    <span style="font-size:11px;color:#4a5568;">4x4 Keypad</span>
  </div>
