...
<div class="component-preview">
  <div class="component-svg-wrap">
    <svg width="120" height="120" viewBox="0 0 120 120" xmlns="http://www.w3.org/2000/svg">
      <path d="M 30,30 Q 50,60 30,90 Q 70,90 90,60 Q 70,30 30,30 Z" fill="#1e293b" stroke="#334155" stroke-width="3" />
      ...
      <text x="50" y="65" fill="#94a3b8" font-family="monospace" font-size="16" font-weight="bold">&ge;1</text>
    </svg>
    <span style="font-size:11px;color:#4a5568;">NOR Gate</span>
  </div>
