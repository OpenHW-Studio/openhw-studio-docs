...
<div class="component-preview">
  <div class="component-svg-wrap">
    <svg width="100" height="100" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
      <rect x="5" y="5" width="90" height="90" rx="4" fill="#1e293b" />
      ...
      <circle cx="85" cy="15" r="3" fill="#cbd5e1" />
      <circle cx="15" cy="85" r="3" fill="#cbd5e1" />
      <circle cx="85" cy="85" r="3" fill="#cbd5e1" />
      ...
      <text x="50" y="55" fill="#f8fafc" font-family="monospace" font-size="8" text-anchor="middle">L298N</text>
    </svg>
    <span style="font-size:11px;color:#4a5568;">L298N Module</span>
  </div>
