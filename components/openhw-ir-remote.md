...
<div class="component-preview">
  <div class="component-svg-wrap">
    <svg width="120" height="180" viewBox="0 0 120 180" xmlns="http://www.w3.org/2000/svg">
      <rect x="25" y="10" width="70" height="160" rx="10" fill="#1e293b" stroke="#0f172a" stroke-width="2" />
      <circle cx="45" cy="30" r="8" fill="#ef4444" />
      <circle cx="75" cy="30" r="8" fill="#3b82f6" />
      <circle cx="60" cy="50" r="8" fill="#cbd5e1" />
      <circle cx="40" cy="70" r="8" fill="#cbd5e1" />
      <circle cx="80" cy="70" r="8" fill="#cbd5e1" />
      <circle cx="60" cy="90" r="8" fill="#cbd5e1" />
      ...
      <path d="M 55 5 L 65 5 L 62 10 L 58 10 Z" fill="#94a3b8" opacity="0.8" />
    </svg>
    <span style="font-size:11px;color:#4a5568;">IR Remote</span>
  </div>
